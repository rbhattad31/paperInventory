...
<?php echo CHtml::dropDownList('criteria',$criteria,Utilities::getCriteriaForSalesList(),array('empty' => 'Select a Criteria',
																									'id'=>'citeriaList')); ?>
<input type="submit" formaction="<?php echo $this->createUrl('reports/exportSales')?>"  value="Export"/>																								
